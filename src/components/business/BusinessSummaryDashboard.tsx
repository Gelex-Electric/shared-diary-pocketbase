    ...
    <div className="space-y-8 pb-12 animate-fade-in relative">
      ...
      <div className="vl-card p-6 md:p-8 flex flex-col md:flex-row md:items-center justify-between gap-6">
        <div>
          ...
          <div className="inline-flex items-center gap-2 mt-3 bg-surface border border-[var(--border)] rounded-xl px-3 py-1.5 shadow-sm min-w-[260px]">
            <Building2 className="w-4 h-4 text-accent shrink-0" />
            <span className="text-[11px] font-bold text-faint uppercase tracking-wider shrink-0">Khu công nghiệp</span>
